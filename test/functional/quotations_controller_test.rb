...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { accepted: @quotation.accepted, asset_request_id: @quotation.asset_request_id, cost: @quotation.cost, date: @quotation.date, description: @quotation.description, title: @quotation.title, vendor_id: @quotation.vendor_id }
    end
  ...
  test "should update quotation" do
    put :update, id: @quotation, quotation: { accepted: @quotation.accepted, asset_request_id: @quotation.asset_request_id, cost: @quotation.cost, date: @quotation.date, description: @quotation.description, title: @quotation.title, vendor_id: @quotation.vendor_id }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
